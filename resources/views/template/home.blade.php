    ...
    <div class="container">
            ...
            <div class="col-lg-4 col-md-8 ms-md-auto">
                <div class="card bg-gradient-primary">
                    <div class="card-body">
                        ...
                        <p class="mt-4 text-white">"I found solution to all my design needs from Creative
                            Tim. I use them as a freelancer in my hobby projects for fun! And its really
                            affordable, very humble guys !!!"</p>
                        <div class="rating mt-3">
        ...
        <div class="row">
            <div class="col-lg-2 col-md-4 col-6 ms-auto">
                <img class="w-100 opacity-6" src="{{ asset('assets/img/logos/gray-logos/logo-apple.svg') }}"
                    alt="Logo">
            </div>
            <div class="col-lg-2 col-md-4 col-6">
                <img class="w-100 opacity-6"
                    src="{{ asset('assets/img/logos/gray-logos/logo-facebook.svg') }}" alt="Logo">
            </div>
            <div class="col-lg-2 col-md-4 col-6">
                <img class="w-100 opacity-6" src="{{ asset('assets/img/logos/gray-logos/logo-nasa.svg') }}"
                    alt="Logo">
            </div>
            <div class="col-lg-2 col-md-4 col-6 ms-lg-0 ms-md-auto">
                <img class="w-100 opacity-6"
                    src="{{ asset('assets/img/logos/gray-logos/logo-vodafone.svg') }}" alt="Logo">
            </div>
            <div class="col-lg-2 col-md-4 col-6 me-md-auto mx-md-0 mx-auto">
                <img class="w-100 opacity-6"
                    src="{{ asset('assets/img/logos/gray-logos/logo-digitalocean.svg') }}" alt="Logo">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="container py-7 postion-relative z-index-2 position-relative">
            <div class="row">
                <div class="col-md-7 mx-auto text-center">
                    ...
                    <p class="text-white mb-5">Cause if you do, it can be yours for FREE. Hit the button
                        below to navigate to Creative Tim where you can find the Design System in HTML. Start a
                        new project or give an old Bootstrap project a new look!</p>
